...
class ArtworksView {
  ...
  handleFilterBtn(e) {
    ...
    this.clearFilterBtns(); // set button active 
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js","moment":"../node_modules/moment/moment.js"}],"views/pages/myLibrary.js":[function(require,module,exports) {
"use strict";
...
var _default = new MyLibraryView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","./../../Toast":"Toast.js"}],"views/pages/guide.js":[function(require,module,exports) {
"use strict";
...
class NewArtworkView {
  ...
  async newArtworkSubmitHandler(e) {
    ...
    try {
      ...
      if (textInputs) textInputs.forEach(textInput => textInput.value = null); //reset radio input 

      const radioInputs = document.querySelectorAll('sl-radio');
      if (radioInputs) radioInputs.forEach(radioInput => radioInput.removeAttribute('checked')); //reset fill input 
